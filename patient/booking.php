                                ...
                                <table width="100%" class="sub-table scrolldown" border="0" style="padding: 50px;border:none">
                                    ...
                                    if ($_GET) {
                                        if (isset($_GET["id"])) {
                                            ...
                                            // Fetch session details including the `nop` from the schedule table
                                            ...
                                            $maxPatients = $row["nop"]; // Retrieve the `nop` from the schedule table
                                            ...
                                            $apponum = $result12->num_rows; // Current number of appointments

                                            // Check if the session is fully booked
                                            if ($apponum >= $maxPatients) {
                                                echo '
                                                    <div class="dashboard-items">
                                                        <div style="text-align:center; padding:20px;">
                                                            <h3>Session Fully Booked</h3>
                                                            <p>Sorry, this session has reached the maximum number of patients.</p>
                                                            <a href="schedule.php"><button class="btn-primary">Back to Schedule</button></a>
                                                        </div>
                                                    </div>';
                                            } else {
                                                $apponum++; // Increment the appointment number for the next booking
                                                echo '
                                                            ...
                                                            <div class="dashboard-items search-items">
                                                                <div style="width:100%">
                                                                    ...
                                                                    <div class="h3-search" style="font-size:18px;">
                                                                        ...
                                                                        Channeling fee: <b>CAD 2 000.00</b>
                                                                    </div>
                                                                    <br>
                                                                </div>
                                                            </div>
