...
<body>
    ...
    <div class="menu">
            <table class="menu-container" border="0">
                <!-- Menu content omitted for brevity -->
            </table>
        </div>
        <?php       
                            ...
                            <?php
                                ...
                                if($result->num_rows == 0){
                                    echo '<tr><td colspan="6">
                                        ...
                                        <a class="non-style-link" href="patient.php"><button class="login-btn btn-primary-soft btn" style="margin-left:20px;">&nbsp; Show all Patients &nbsp;</button></a>
                                        </center>
                                        </td></tr>';
                                } else {
    ...
    if($_GET){
            ...
            $medical_concerns = $row["medical_concerns"]; // Added new field
            echo '
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr><td class="label-td" colspan="2"><label for="name" class="form-label">Patient ID: </label></td></tr>
                            ...
                            <tr><td class="label-td" colspan="2"><label for="nic" class="form-label">NIC(Your insurance number): </label></td></tr>
                            ...
                            <tr><td class="label-td" colspan="2"><label for="spec" class="form-label">Address: </label></td></tr>
                            <tr><td class="label-td" colspan="2">'.$address.'<br><br></td></tr>
                            <tr><td class="label-td" colspan="2"><label for="name" class="form-label">Date of Birth: </label></td></tr>
                            <tr><td class="label-td" colspan="2">'.$dob.'<br><br></td></tr>
                            <tr><td class="label-td" colspan="2"><label for="name" class="form-label">Medical Concerns: </label></td></tr>
                            <tr><td class="label-td" colspan="2">'.$medical_concerns.'<br><br></td></tr> <!-- New field displayed -->
                            <tr><td colspan="2"><a href="patient.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn"></a></td></tr>
                        </table>
                        </div>
                    </center>
                    <br><br>
